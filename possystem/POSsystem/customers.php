...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <input type="text" name="query" style="border:1px solid #CCC; color: #333; width:210px; height:30px;" placeholder="Search customers..." /><input type="submit" id="btnsearch" value="Search" name="search" />
        </form>
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="border:1px solid #999; color:#033;">
     ...
     <tr>
     <th colspan="6" align="center" height="55px" style="border-bottom:1px solid #033; background: #999; color:#FFF;"> Customer Information Table</th>
    </tr>
...
<a href="delete_customer.php?id=<?php echo md5($row['id']);?>"><input type="button" value="Delete" style="width:15; height:20; color:#FFF; background: #900; border:1px solid #900; border-radius:3px;"></a>
...
<div id="popup-container">
    ...
    <p style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;font-size:16px;"> Add Customer Form </p>
    </div>
    <br>
